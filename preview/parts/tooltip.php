<div id="block_tooltip" class="block_wrap">
    <div class="block">
        ...
        <div class="content">
            ...
            <ul class="msg">
                <li class="notice_msg">
                    <ul>
                        <li><strong>data-tip-position</strong> set position of tooltip (top, right, bottom, left)</li>
                        <li><strong>data-tip-arrow</strong> set position of arrow (top, center, bottom, left, right)</li>
                        <li><strong>tooltip_trigger</strong> class use to trigger tip to show</li>
                        <li><strong>inactive</strong> class use to start tooltip visible and hide on hover</li>
                    </ul>
                </li>
            </ul>
